              ...
              <div class="confirm-tips">
                ...
                <ul>
                  <li class="regi_form_input">
                    ...
                    <input type="text" tabindex="1" v-model="userName" name="loginnamen">
                  </li>
                  <li class="regi_from_input noMargin">
                    <i class="icon IconPwd"></i>
                    <input type="password" tabindex="2" v-model="userPwd" name="password" @keyup.enter="login">
                  </li>
                </ul>
              </div>
